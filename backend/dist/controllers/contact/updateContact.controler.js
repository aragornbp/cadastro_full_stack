...
const updateClientService_service_1 = require("../../services/contact/updateClientService.service");
const UpdateContactController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const contact = req.body;
    const id = req.params.id;
    const data = yield (0, updateClientService_service_1.updateContactService)(contact, id);
