...
const createClientService_service_1 = require("../../services/client/createClientService.service");
const createClientController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const client = req.body;
    const data = yield (0, createClientService_service_1.createClientService)(client);
